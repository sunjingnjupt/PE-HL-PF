...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget_3->setGeometry(QRect(0, 0, 289, 336));
        ...
        cornerNumCB = new QCheckBox(layoutWidget_3);
        cornerNumCB->setObjectName(QStringLiteral("cornerNumCB"));

        horizontalLayout_16->addWidget(cornerNumCB);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_15->setText(QApplication::translate("MainWindow", "  cornerNum", Q_NULLPTR));
        cornerNumCB->setText(QApplication::translate("MainWindow", "cornerNum", Q_NULLPTR));
